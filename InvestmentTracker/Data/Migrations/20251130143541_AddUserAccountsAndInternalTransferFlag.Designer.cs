...
namespace InvestmentTracker.Data.Migrations
{
    ...
    [Migration("20251130143541_AddUserAccountsAndInternalTransferFlag")]
    partial class AddUserAccountsAndInternalTransferFlag
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InvestmentTracker.Models.FinancialMonthOverride", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("TargetMonth", "UserId")
                        .IsUnique();

                    b.ToTable("FinancialMonthOverrides");
                });
            ...
            modelBuilder.Entity("InvestmentTracker.Models.ImportProfile", b =>
                {
                    ...
                    b.Property<BankImportProfile>("ProfileData")
                        .IsRequired()
                        .HasColumnType("jsonb");
            ...
            modelBuilder.Entity("InvestmentTracker.Models.InvestmentProvider", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("InvestmentTracker.Models.UserAccount", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
